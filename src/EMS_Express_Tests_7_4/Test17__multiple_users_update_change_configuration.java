...
/**
* ----------------
* This test tests the update and change configuration actions of multiple-users-changes menu
* ----------------
* Tests:
...
* 	 2. The users configuration should be reset successfully.
* 	 3. The users configuration should be updated successfully.
...
public class Test17__multiple_users_update_change_configuration {
  ...
  public Test17__multiple_users_update_change_configuration(String browser) {
  ...
  @Test
  public void Manage_multiple_users_update_change_configuration() throws Exception {
	 
	Log.startTestCase(this.getClass().getName());
	
	// Set vars
	String srcUserPrefix 	= "upChngConfUser";
