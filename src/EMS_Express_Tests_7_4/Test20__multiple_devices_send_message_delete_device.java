...
public class Test20__multiple_devices_send_message_delete_device {
  ...
  public Test20__multiple_devices_send_message_delete_device(String browser) {
  ...
  public void Manage_multiple_devices_change_language_delete_device() throws Exception {
	...
	String dispPrefix    = "sMsgDelDevUser" + testFuncs.getId();
	int usStartIdx 		 = 1;
    ...
    testFuncs.setMultipleDevicesAction(driver, map);
    testFuncs.searchStr(driver, dispPrefix + "_1 " + testFuncs.readFile("mac_1.txt") + " Finished");
    testFuncs.searchStr(driver, dispPrefix + "_2 " + testFuncs.readFile("mac_2.txt") + " Finished");
    testFuncs.searchStr(driver, dispPrefix + "_3 " + testFuncs.readFile("mac_3.txt") + " Finished");
